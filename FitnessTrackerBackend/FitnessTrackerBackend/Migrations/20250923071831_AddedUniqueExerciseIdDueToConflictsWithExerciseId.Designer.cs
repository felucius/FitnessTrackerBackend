...
namespace FitnessTrackerBackend.Migrations
{
    ...
    [Migration("20250923071831_AddedUniqueExerciseIdDueToConflictsWithExerciseId")]
    partial class AddedUniqueExerciseIdDueToConflictsWithExerciseId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FitnessTrackerBackend.Models.Exercise", b =>
                {
                    b.Property<Guid>("UniqueExerciseId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValueSql("NEWID()");
            ...
            modelBuilder.Entity("FitnessTrackerBackend.Models.Progression", b =>
                {
                    b.HasOne("FitnessTrackerBackend.Models.Exercise", "Exercise")
                        ...
                        .HasForeignKey("UniqueExerciseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
